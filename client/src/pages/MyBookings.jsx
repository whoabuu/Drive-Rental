    ...
    className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl '>
      ...
      <div>
        {bookings.map((booking, index)=>(
          ...
          key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-gray-200
            rounded-lg shadow-md mt-5 first:mt-12'>
            ...
            <div className='md:col-span-1'>
               ...
               <p className='text-gray-700'>{booking.car.year} : {booking.car.category} : {booking.car.location}</p>
            </div>
